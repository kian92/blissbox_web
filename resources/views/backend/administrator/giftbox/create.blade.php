...
@section('body', 'backend box-create')
            ...
            <form class="col s12" v-on:submit.prevent="store">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s12 m3">
                        <input type="text" name="price" id="price" v-validate="'required'" v-model="create.price">
                ...
                <div class="row">
                    <div class="col s12">
                        <textarea id="description" class="materialize-textarea" v-model="create.description"></textarea>
...
<script src="{{ asset('js/backend/giftbox/create.js') }}"></script>
<script>
