...
@section('body', 'backend voucher-activate')
...
@section('content')
    <div class="valign-wrapper">
        <div class="container" id="activate">
            ...
            <div class="row">
                <form class="col s12" v-on:submit.prevent="activateWebVoucher" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col s12">
                            <h4 class="center-align">Register Voucher</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col s12">
...
@section('inline-script')
    ...
    <script src="{{ asset('js/backend/voucher/physical_activate.js') }}"></script>
@endsection