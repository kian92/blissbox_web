...
@section('body', 'backend history')

@section('content')
    <div class="valign-wrapper">
        <div class="container" id="history">
            <h4 class="center-align" style="margin-bottom: 50px;">Purchase History</h4>
            <div class="row" v-for="item in items">
                <ul class="collapsible" data-collapsible="accordion">
                    <collapsible :item="item"></collapsible>
                </ul>
            </div>
        </div>
    </div>
...
@section('inline-script')
    ...
    <script src="{{ asset('js/backend/purchase/history.js') }}"></script>
    <script>
    </script>
@endsection