...
@section('title', 'Exchange My Gift Box')
        ...
        <section id="hero-banner">
            <div class="d-flex">
                <div class="captions">
                    ...
                    <h1 class="font-weight-bold">Exchange My Gift Box</h1>
                </div>
            </div>
        </section>
        <section id="faq">
            <div class="container">
                <div class="container container-content">
                    <div class="d-flex">
                        ...
                        <div class="f-60">
                            <h3 class="my-5">Exchange My Gift Box</h3>
                                    ...
                                    <div class="card-header" role="tab" id="headingOne">
                                        <h5 class="mb-0">
                                            <a data-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                Can I exchange my gift box?
                                            </a>
                                        </h5>
                                    </div>
                                    <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                                        <div class="card-body">
                                            The exchange policy will be found in our T&Cs. the exchange is possible. Please click on the link to
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header" role="tab" id="headingTwo">
                                        <h5 class="mb-0">
                                            <a class="collapsed" data-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                My gift box has expired, can I still exchange for a new box?
                                            </a>
                                        </h5>
                                    </div>
