...
@section('title', 'Register My Blissbox')
        ...
        <section id="hero-banner">
            <div class="d-flex">
                <div class="captions">
                    ...
                    <h1 class="font-weight-bold">Register My Blissbox</h1>
                </div>
            </div>
        </section>
        <section id="faq">
            <div class="container">
                <div class="container container-content">
                    <div class="d-flex">
                        ...
                        <div class="f-60">
                            <h3 class="my-5">Register My Blissbox</h3>
                            ...
                            <div id="accordion" role="tablist">
                                <div class="card">
                                    ...
                                    <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                                        <div class="card-body">
                                            To register please proceed to the following page, <a href="{{ url('/register') }}">https://www.blissbox.asia/register/</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header" role="tab" id="headingTwo">
                                        <h5 class="mb-0">
                                            <a class="collapsed" data-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                How long are the Blissbox gift box valid?
                                            </a>
                                        </h5>
                                    </div>
                                    <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
                                        <div class="card-body">
                                            The validity date is running for 12 months after date of purchase
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    <div class="card-header" role="tab" id="headingThree">
                                        <h5 class="mb-0">
                                            <a class="collapsed" data-toggle="collapse" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                What is the loss and theft guarantee?
                                            </a>
                                        </h5>
                                    </div>
                                    <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
                                        <div class="card-body">
                                            Blissbox guarantees its beneficiaries from the loss or theft if the voucher reference has been registered on there account.
                                        </div>
                                    </div>
                                </div>
                            </div>
