...
@section('title', 'FAQ - Shipping Information')
        ...
        <section id="hero-banner">
            <div class="d-flex">
                <div class="captions">
                    ...
                    <h1 class="font-weight-bold">Shipping Information</h1>
                </div>
            </div>
        </section>
        <section id="faq">
            <div class="container">
                <div class="container container-content">
                    <div class="d-flex">
                        ...
                        <div class="f-60">
                            <h3 class="my-5">Shipping Information</h3>
                                    ...
                                    <div class="card-header" role="tab" id="headingTwo">
                                        <h5 class="mb-0">
                                            <a class="collapsed" data-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                                I ordered an e-box, when will I receive it?
                                            </a>
                                        </h5>
                                    </div>
                                    <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
                                        <div class="card-body">
                                            The e-box is send via email to the email the buyer has entered in the cart. It is generally sent on the spot after the cart has been confirmed and the payment received.
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
                                        <div class="card-body">
                                            The delivery is to be followed in your account history of my purchase.
                                        </div>
                                    </div>
                                </div>
                            </div>
