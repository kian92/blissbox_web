...
@section('title', 'FAQ - Order and Payment')
        ...
        <section id="hero-banner">
            <div class="d-flex">
                <div class="captions">
                    ...
                    <h1 class="font-weight-bold">Order and Payment</h1>
                </div>
            </div>
        </section>
        <section id="faq">
            <div class="container">
                <div class="container container-content">
                    <div class="d-flex">
                        ...
                        <div class="f-60">
                            <h3 class="my-5">Order and Payment</h3>
                            ...
                            <div id="accordion" role="tablist">
                                    ...
                                    <div class="card-header" role="tab" id="headingOne">
                                        <h5 class="mb-0">
                                            <a data-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                How to benefit from my promo code?
                                            </a>
                                        </h5>
                                    </div>
                                    <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
                                        <div class="card-body">
                                            The promo code needs to be applied by the buyer on the cart in order to benefit from the reduction it contains and before its validity date expires.
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
                                        <div class="card-body">
                                            Yes, the cancellation of the order is possible. Please click on the link cancellation to check all the T&Cs.
                                ...
                                <div class="card">
                                    ...
                                    <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
                                        <div class="card-body">
                                            The different payment method are as follow, Paypal, Credit card and Stripe
                                        </div>
                                    </div>
                                </div>
                            </div>
