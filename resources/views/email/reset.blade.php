...
<body>
<div class="container" style="max-width:800px; width: 100%; padding-right: 15px; padding-left: 15px; margin-right: auto; margin-left: auto;">
    <table style="border-collapse:collapse;">
        <!-- Start of Heading and Logo -->
        <tr>
            <td colspan="2" style="border-top-style:none; text-align:center; font-size:0.875rem; padding: 1rem 0;">
        ...
        <!-- End of Heading and Logo -->

        <!-- Start of Body Content -->
        <tr>
            <td colspan="2" style="padding: 0 15px">
                <h2 style="text-align: center">You are receiving this email because we received a password reset request for your account.</h2>
                <div style="text-align: center; margin: 30px 0;">
                    <a href="{{ $actionUrl }}" style="cursor: pointer; background: #FECE51; padding: 10px 35px; border-radius: 25px; text-decoration: none; color: #000; display: inline-block; margin: 0 auto;">Reset Password</a>
                </div>
        ...
        <!-- Start of Footer -->
        <tr style="background-color:#111821; color:#FFF;">
            <td colspan="2">
                    ...
                    <tr style="text-align: center;">
                        <td style="padding-top:13px;padding-bottom:8px;padding-right:0;padding-left:0;font-size:0.875rem !important;">
                            <a href="https://www.facebook.com/blissboxasia/" target="_blank"
                               style="text-decoration:none; display:inline-block; margin-top:0; margin-bottom:0; margin-right:25px; margin-left:25px;">
                            ...
                            <a href="https://www.instagram.com/blissboxasia/" target="_blank" style="text-decoration:none; display:inline-block; margin: 0 25px;">
                                <img src="https://storage.googleapis.com/blissbox-175105.appspot.com/Email%20Template/002-instagram-logo.png" alt="Instagram">
                            </a>
                            <a href="https://sg.linkedin.com/company/blissbox-asia" target="_blank" style="text-decoration:none; display:inline-block; margin: 0 25px;">
